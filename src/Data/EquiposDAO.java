...
public class EquiposDAO extends BaseHibernateDAO {
	...
	public Equipos findById(java.lang.Integer id) {
		...
		try {
			Equipos instance = (Equipos) getSession().get("Equipos", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Equipos instance) {
		...
		try {
			List results = getSession().createCriteria("Equipos")
	...
	public List findByModelo(Object modelo) {
		return findByProperty(MODELO, modelo);
	}

	public List findByMarca(Object marca) {
